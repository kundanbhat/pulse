...
function getReport()
{
		...
		$("#pulseData").html("");
		$.get("revenuereport",{ startDate:$("#startDate").val(), endDate:$("#endDate").val(), reportType:$("#reportType").val()}, function(data, status){
			$("#pulseData").html(data);
			$("#example1").DataTable({
			...
			<div class="sidebar">
               ...
               with font-awesome or any other icon font library -->
						...
						<li class="nav-item stay-open"><a href="#" class="nav-link"> <i
							...
							<ul class="nav nav-treeview stay-open">
								<li class="nav-item "><a href="revenueView" class="nav-link active">
					...
					<div class="row mb-2">
						...
						<div class="col-sm-3">
							...
							Type<select name="reportType" id="reportType"
								class="form-control">
								<%if(level==3){ %>
								<option value="bucketwise">BucketWise</option>
								<%} %>
			...
			<section class="content">
				<div class="container-fluid">
					<div class="card">
						...
						<!-- /.card-header -->
						<div class="card-body" id="pulseData">
													</div>
						<!-- /.card-body -->
					</div>
