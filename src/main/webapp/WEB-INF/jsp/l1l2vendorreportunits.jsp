...
">
	...
	<tbody>
		<%
		    ...
		    Map<String, Map<String,Map<String,Map<String,Double>>>> expenseMap=(Map<String, Map<String,Map<String,Map<String,Double>>>>)request.getAttribute("expensemap");
			for(Map.Entry<String, Map<String,Map<String,Map<String,Double>>>>  entry : expenseMap.entrySet())
			{
				Map<String,Map<String,Map<String,Double>>> l2map=expenseMap.get(entry.getKey());
